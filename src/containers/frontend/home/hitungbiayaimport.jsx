...
return (
    ...
    <div className='gpt3_home_fitur_bg mb-4 '  >
    
    <div className='text-white fs-2 text-center mt-lg-5 mb-5 fw-bold'>Hitung Biaya Import</div>
    
    <div className='gpt3__whatgpt3_formhitunghome section__margin_fitur'  id='whpt3'>
    ...
    <button  className='gpt3__home_hitungbiaya'  type="submit" ><label className='text-white fs-5 font-weight-bold'>Hitung Biaya</label></button>
    ...
    <button  className='gpt3__home_hitungbiaya' 
      type="submit" ><label className='text-white fs-5 font-weight-bold'>Hitung Biaya</label></button>
...
export default Hitungbiayaimport