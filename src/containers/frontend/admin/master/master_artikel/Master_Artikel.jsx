    ...
    const { handleChange, values, setFieldValue } = useFormik({
      ...
      const onChangePicture = e => {
       ...
       try {
         ...
         const headlineid= Number(inputheadline)
         const inputgambar_="/path/"+inputgambar
     
     const formartikel= new FormData
     formartikel.append("title",inputtitle)
     formartikel.append("slug",inputslug)
     formartikel.append("description",inputdeskripsi)
     formartikel.append("headline_id",headlineid)
     formartikel.append("picture",inputgambar_)
                ...
                <div className='row m-4'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <div className='form-group'>
                            ...
                            <input type='textbox' className='form-control'  value={inputtitle }  onChange={(e) => setTitle(e.target.value)} />
                    ...
                    <div className='form-group'>
                            ...
                            <input type='textbox' className='form-control' value={ inputslug }  onChange={(e) => setSlug(e.target.value)} />
